...
// Called by user code
IMGUI_IMPL_API bool     ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info, VkRenderPass render_pass, VkSampleCountFlagBits msaaSamples = VK_SAMPLE_COUNT_1_BIT);//I added a parameter to change msaa -- Xiao Zhang
...
IMGUI_IMPL_API bool     ImGui_ImplVulkan_CreateDeviceObjects(VkSampleCountFlagBits msaaSamples = VK_SAMPLE_COUNT_1_BIT);//I added a parameter to change msaa -- Xiao Zhang
