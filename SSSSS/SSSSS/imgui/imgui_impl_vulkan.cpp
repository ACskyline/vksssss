...
bool ImGui_ImplVulkan_CreateDeviceObjects(VkSampleCountFlagBits msaaSamples)
{
    VkResult err;
	...
	ms_info.rasterizationSamples = msaaSamples;//I changed it from VK_SAMPLE_COUNT_1_BIT -- Xiao Zhang
...
bool    ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info, VkRenderPass render_pass, VkSampleCountFlagBits msaaSamples)//I added a parameter to change msaa -- Xiao Zhang
{
    ...
    ImGui_ImplVulkan_CreateDeviceObjects(msaaSamples);
